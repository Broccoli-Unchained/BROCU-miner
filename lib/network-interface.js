...
var tokenContractJSON = require('../contracts/_BroccoliUnchained.json');
...
module.exports =  {
  ...
  async submitMiningSolution(addressFrom, solutionNumber, challengeDigest) {
    ...
    try {
      // Get the pending transaction count to include unconfirmed transactions
      const pendingTxCount = await this.wallet.getTransactionCount("pending");
