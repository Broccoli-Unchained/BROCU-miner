...
module.exports =  {
  ...
  init( )
  {
    logStorage = new LocalStorage(this.getBROCULocalFolderPath()  );
    logStorage = new LocalStorage(this.getBROCULocalFolderPath()+'/logs');
  ...
  getBROCULocalFolderPath()
  {
    return this.getOSLocalDataFolderPath()  + '/.brocu';
  },
  ...
  logsExist()
  {
    if (!fs.existsSync(this.getBROCULocalFolderPath()) || !fs.existsSync(this.getBROCULocalFolderPath() +'/logs' )  ){
      return false;
    }

    if (!fs.existsSync(this.getBROCULocalFolderPath()+'/logs/stdout' ) ){
      return false;
    }
