...
NOTE: The web3provider need not be a provider like infra or alchemy, it can also be almost any public rpc node such as [PublicNode](https://www.publicnode.com) or [MeowRPC](https://meowrpc.com). Just make sure your rate-limit is sufficient. With that said you may be better off running your own node. Also, when solo mining on Polygon you'll likely need to set the gas_price_gwei and priority_gas_fee_gwei to at least 30. Fees can also be set 0.01 for L2 networks like Base or WorldChain. 
